  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 active:scale-[0.98] transition-all shadow-sm shadow-primary/20"
      >
