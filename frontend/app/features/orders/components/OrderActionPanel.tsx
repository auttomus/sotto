    ...
    return (
      <div className="bg-card border-t border-border p-4 pb-safe shrink-0 shadow-lg">
        ...
        <div className="flex gap-3">
          <Button
            variant="secondary"
            className="flex-1 font-bold text-xs py-2.5 rounded-md border border-border text-foreground hover:bg-muted cursor-pointer disabled:opacity-50"
          ...
          <Button
            variant="primary"
            className="flex-1 font-bold text-xs py-2.5 rounded-md bg-success hover:opacity-90 text-success-foreground border-0 shadow-lg shadow-success/10 active:scale-[0.99] transition cursor-pointer disabled:opacity-50 flex items-center justify-center gap-1.5"
      ...
      <div className="bg-card border-t border-border p-4 pb-safe shrink-0 shadow-lg space-y-3">
        ...
        <div className="flex gap-3">
          ...
          {isBuyer && onPay && (
            <Button
              variant="primary"
              className="flex-[2] font-extrabold text-xs py-2.5 rounded-md bg-primary hover:opacity-90 text-primary-foreground border-0 shadow-lg shadow-primary/10 active:scale-[0.99] transition cursor-pointer disabled:opacity-50 flex items-center justify-center gap-1.5"
              onClick={onPay}
              disabled={isActionLoading || isPaying}
            >
              {isPaying ? (
