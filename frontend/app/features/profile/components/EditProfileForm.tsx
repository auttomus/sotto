...
export function EditProfileForm({ profile, onCancel, onSuccess }: EditProfileFormProps) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-2 space-y-4 bg-muted/30 p-5 rounded-md border border-border">
        <div>
        ...
        <div>
          ...
          <div className="w-full bg-muted border border-border rounded-md p-3 text-sm text-muted-foreground cursor-not-allowed">
