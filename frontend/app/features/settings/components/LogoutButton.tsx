...
export function LogoutButton() {
  ...
  return (
    <section className="pt-4">
      <Button 
        variant="danger" 
        className="w-full h-12 rounded-2xl flex items-center justify-center gap-2 font-bold shadow-lg shadow-red-500/10 text-xs cursor-pointer active:scale-[0.98]"
