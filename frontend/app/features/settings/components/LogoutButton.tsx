...
export function LogoutButton() {
  ...
  return (
    <section className="pt-4">
      <Button 
        variant="danger" 
        className="w-full h-12 rounded-md flex items-center justify-center gap-2 font-bold shadow-lg shadow-destructive/10 text-xs cursor-pointer active:scale-[0.98]"
