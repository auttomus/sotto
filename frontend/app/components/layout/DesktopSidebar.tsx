      ...
      <nav className="flex-1 space-y-2">
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                "flex items-center gap-4 px-3 py-3 rounded-md transition-all group relative",
                isActive 
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            cn(
              "flex items-center gap-4 px-3 py-3 rounded-md transition-all group relative mt-4",
              isActive 
                ? "bg-primary/10 text-primary font-bold" 
                : "text-muted-foreground hover:bg-accent hover:text-accent-foreground font-medium"
            )
